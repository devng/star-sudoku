...
public class Export {
    public static String getHTMLString(SerGrid sg) {
        ...
        sb.append("</table>\n");
        sb.append("<p>Generated with Star SUDOKU (<a href=\"http://starsudoku.sf.net\" target=\"_blank\">http://starsudoku.sf.net</a>)</p>\n");
        sb.append("</body>\n");
        sb.append("</html>\n");
    ...
    public static String getRTFString(SerGrid sg) {
        ...
        sb.append("\\par \\pard\\plain \\ltrpar\\s1\\cf0{\\*\\hyphen2\\hyphlead2\\hyphtrail2\\hyphmax0}\\ql {\\rtlch \\ltrch\\loch\\f1\\fs20\\lang1031\\i0\\b0 Generated with Star SUDOKU (http://starsudoku.sf.net)}\\par }");
        return sb.toString();
    }
